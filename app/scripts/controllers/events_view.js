...
angular.module('angularApp')
  .controller('EventsViewCtrl', function($scope, $http, config, $q, $compile, $rootScope, $timeout, uiCalendarConfig) {
        ...
        .success(function (response) {
          ...
          for (var key in response) {
            ...
            $scope.calendarEvents.push({
              title: response[key].title, start: dateEventStart, end: dateEventEnd, allDay: false,

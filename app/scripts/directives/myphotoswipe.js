...
(function () {
  ...
  function bkPhotoswipe(angular, Photoswipe) {

    return angular
      .module('angularApp')
      .directive('bkPhotoswipe', bkPhotoswipeDirective);

    function bkPhotoswipeDirective($compile, $http, $templateCache) {
      return {
        restrict: 'AE',
        replace: true,
        scope: {
      ...
      function linkFn(scope, iElement, iAttrs) {
        scope.template = scope.template || 'views/bk_photoswipe.html';
  ...
  if (typeof define === 'function' && define.amd) {
    define(['angular', 'photoswipe'], bkPhotoswipe);
  } else if (typeof module !== 'undefined' && module && module.exports) {
    bkPhotoswipe(angular, require('photoswipe'));
    module.exports = 'bkPhotoswipe';
  } else {
    bkPhotoswipe(angular, (typeof global !== 'undefined' ? global : window).Photoswipe);
  }
})();
